 ...
 * All rights reserved.
 *
 * @file	Autopilot_GPS.h
 * @brief	GPS receiver header file
 * 
*/
...
#include <Autopilot_Common/Location.h>
#include <Autopilot_Param/Autopilot_Param.h>
#include <Autopilot_Math/Autopilot_Math.h>
#include <Autopilot_Vehicle/Autopilot_Vehicle.h>
#include "GPS_detect_state.h"
#include <Autopilot_SerialManager/Autopilot_SerialManager.h>
#include <Autopilot_RTC/Autopilot_RTC.h>
...
#define UNIX_OFFSET_MSEC (17000ULL * 86400ULL + 52ULL * 10ULL * Autopilot_MSEC_PER_WEEK - GPS_LEAPSECONDS_MILLIS)

class Autopilot_GPS_Backend;

/// @class Autopilot_GPS
/// GPS driver main class
class Autopilot_GPS
{
    friend class Autopilot_GPS_ERB;
    friend class Autopilot_GPS_GSOF;
    friend class Autopilot_GPS_MAV;
    friend class Autopilot_GPS_MTK;
    friend class Autopilot_GPS_MTK19;
    friend class Autopilot_GPS_NMEA;
    friend class Autopilot_GPS_NOVA;
    friend class Autopilot_GPS_PX4;
    friend class Autopilot_GPS_SBF;
    friend class Autopilot_GPS_SBP;
    friend class Autopilot_GPS_SBP2;
    friend class Autopilot_GPS_SIRF;
    friend class Autopilot_GPS_UBLOX;
    friend class Autopilot_GPS_Backend;

public:
    Autopilot_GPS();

    /* Do not allow copies */
    Autopilot_GPS(const Autopilot_GPS &other) = delete;
    Autopilot_GPS &operator=(const Autopilot_GPS&) = delete;

    static Autopilot_GPS &get_singleton() {
        return *_singleton;
    }
   ...
   enum GPS_Config {
    ...
    void init(const Autopilot_SerialManager& serial_manager);
    ...
    static const struct Autopilot_Param::GroupInfo var_info[];

    void Write_Autopilot_Logger_Log_Startup_messages();
...
protected:
    ...
    Autopilot_Int8 _type[GPS_MAX_RECEIVERS];
    Autopilot_Int8 _navfilter;
    Autopilot_Int8 _auto_switch;
    Autopilot_Int8 _min_dgps;
    Autopilot_Int16 _sbp_logmask;
    Autopilot_Int8 _inject_to;
    uint32_t _last_instance_swAutopilot_ms;
    Autopilot_Int8 _sbas_mode;
    Autopilot_Int8 _min_elevation;
    Autopilot_Int8 _raw_data;
    Autopilot_Int8 _gnss_mode[GPS_MAX_RECEIVERS];
    Autopilot_Int16 _rate_ms[GPS_MAX_RECEIVERS];   // this parameter should always be accessed using get_rate_ms()
    Autopilot_Int8 _save_config;
    Autopilot_Int8 _auto_config;
    Autopilot_Vector3f _antenna_offset[GPS_MAX_RECEIVERS];
    Autopilot_Int16 _delay_ms[GPS_MAX_RECEIVERS];
    Autopilot_Int8 _blend_mask;
    Autopilot_Float _blend_tc;

    uint32_t _log_gps_bit = -1;

private:
    static Autopilot_GPS *_singleton;
    ...
    Autopilot_GPS_Backend *drivers[GPS_MAX_RECEIVERS];
    Autopilot_HAL::UARTDriver *_port[GPS_MAX_RECEIVERS];
